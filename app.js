...
const days=[
 ['摸清起点','2026 数学卷诊断','只做能独立完成的题，标记犹豫题。','2024 物理卷诊断','记录概念、实验、计算三类得分。','完成两科诊断','统计板块得分与五类错因。','html/papers/2026-math-viewer.html','papers/downloaded/2024/physics/2024-physics.pdf','100 分钟','70 分钟'],
 ...
 ['第一周检测','基础部分限时','选择、填空及 17–22 题。','概念与力学限时','选择题加两道力学计算。','数学基础 ≥ 52/62','本周物理内容正确率 ≥ 80%。','papers/downloaded/2022/math/2022-math.pdf','papers/downloaded/2022/physics/2022-physics.pdf','90 分钟','65 分钟'],
 ...
 ['第二周模考','2023 数学整卷','严格计时 110 分钟，保留所有过程。','2023 物理整卷','严格按正式考试时长完成。','数学 ≥ 75，物理 ≥ 58','当天完成逐题订正。','papers/downloaded/2023/math/2023-math.pdf','papers/downloaded/2023/physics/2023-physics.pdf','110 分钟','65 分钟'],
 ...
 ['中档专项','函数与几何综合第一问','先拿能拿的，再攻第二问。','实验操作复盘','口述全部必考实验操作步骤。','综合第一问全对','实验操作考核要点全覆盖。','math/past-questions.md','physics/past-questions.md','85 分钟','60 分钟'],
 ['数学模考','2024 数学整卷','正式计时 110 分钟，最后 5 分钟检查基础题。','错题回炉','重做最近三天的物理错题。','数学目标 ≥ 80','非知识性失分不超过 5 分。','papers/downloaded/2024/math/2024-math-paper.pdf','physics/formula-sheet.md','110 分钟','55 分钟'],
 ['错题回炉','数学错题回炉','重做昨日错题并写出错误原因。','弱项收口','只补反复出错的两个点。','物理目标 ≥ 64','选择和实验基础分 ≥ 85%。','math/formula-sheet.md','physics/exam-points.md','60 分钟','60 分钟'],
 ['弱项收口','弱项专题收口','只补最近两套卷反复出现的弱项。','实验操作验收','口述全部实验操作并自评。','按正式时间完成','新错题不再大面积扩展专题。','math/exam-points.md','physics/past-questions.md','85 分钟','60 分钟'],
 ['终局检验','2021 数学整卷','110 分钟，基础正确率 ≥ 90%。','2021 物理整卷','65 分钟，基础稳定输出。','基础 ≥ 90%','非知识失分 ≤ 3 分。','papers/downloaded/2021/math/2021-math.pdf','papers/downloaded/2021/physics/2021-physics.pdf','110 分钟','65 分钟']
];
...
function renderProgress(){const count=state.completed.length,pct=Math.round(count/21*100);$('completedDays').textContent=count;$('progressPercent').textContent=`${pct}%`;const ring=$('progressRing');if(ring)ring.style.setProperty('--progress',`${pct*3.6}deg`);$('progressMessage').textContent=count===21?'三周训练完成，保持整卷节奏。':count>=14?'进入整卷阶段，重点控制非知识性失分。':count>=7?'基础框架已建立，开始突破中档模型。':'先完成诊断，找到最值得补的分数。'}
