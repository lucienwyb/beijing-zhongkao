...
<style>
  ...
  .dl-viewer-link{{display:inline-block;margin-left:10px;background:var(--green,#176b4d);color:#fff;padding:6px 14px;border-radius:6px;font-size:13px;font-weight:600}}
  ...
  .dl-empty{{color:var(--muted);font-size:14px;padding:24px 18px;line-height:1.7;text-align:center;background:var(--paper);border:1px dashed var(--line);border-radius:var(--radius)}}
...
<main class="dl-main">
  ...
  <p style="color:var(--muted);font-size:13px;margin:0 0 6px">
    ...
    <span class="cov cov-md">紫 = 文字版 MD</span> ·
    <span class="cov cov-html">黄 = 图片版</span> ·
