...
本计划面向**基础已学完、目标数学 75–82 / 100、物理笔试 54–63 / 70** 的中等偏上考生。每日数学 + 物理合计约 **2–2.5 小时**（数学约 80–110 分钟，物理约 55–75 分钟），节奏为四步循环：**知识唤醒（含重做昨日错题）→ 限时训练 → 订正归因 → 次日重做**。

- **隔日重做不是额外加时**，而是融入次日的"知识唤醒"——每天开头先用 5 分钟遮住答案重做昨日 1–2 道错题或口述核心结论，再进入当天新内容。这样每道错题天然间隔 24 小时复习一次，直接对抗遗忘曲线最陡的最初两天。
- **整卷检测日（第 7/14/21 天，两科合计约 3 小时）**建议数学放上午、物理放下午分时段完成，避免连续疲劳导致后半程非知识性失分；检测当晚只做订正归因，不再加新题。
- **即时反馈**：每套练习做完立刻对照解析自评——[past-questions.md](math/past-questions.md) 含逐年逐题解答与干扰项分析，各年整理卷（`papers/math|physics/*.md`）含官方标答，[真题下载页](downloads.html)的官方 PDF 附原卷答案。反馈越即时、订正越有效，不要攒着隔天再看。

基础偏弱（数学 < 65）的考生建议把每天的中档/压轴时间挪给基础题限时提速，第 20 天"压轴保分收口"可只保第 27、28 题第一问。

### 考前 3 天收口清单

21 天计划的最后 3 天（Day 19–21）分散在错题回炉、压轴保分、终局检验，建议另用一页纸汇总以下收口项，考前一晚逐条打勾：

- **数学**：口述易错概念边界（分式有意义 vs 值为零、$\Delta=0$ 含义、反比例增减性、直径对圆周角等，完整对照表见 [past-questions.md](math/past-questions.md) 备考建议末尾）；默写距离比较法、切线两套路、第 28 题三步法；检查计算器/作图工具。
- **物理**：口述核心公式适用条件（$P=U^2/R$ 仅纯电阻、$P=Fv$ 仅匀速同向、$F=G/n$ 忽略动滑轮重等，详见 [formula-sheet.md](physics/formula-sheet.md)）；默写动态电路四步链、浮力三法、实验结论“带控制条件”；复述实验操作扣分点。
